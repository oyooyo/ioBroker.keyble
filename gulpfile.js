...
gulp.task('rename', function ()  {
    var newname;
    var author = 'oyooyo';
    var email  = 'joachim.schaefer@gmx.net';
    ...
    if (!newname) {
        console.log('Please write the new keyble name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/keyble.png')) {
        fs.renameSync(__dirname + '/admin/keyble.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/keyble.html')) {
        fs.renameSync(__dirname + '/widgets/keyble.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/keyble/js/keyble.js')) {
        fs.renameSync(__dirname + '/widgets/keyble/js/keyble.js', __dirname + '/widgets/keyble/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/keyble')) {
        fs.renameSync(__dirname + '/widgets/keyble',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /keyble/g,
        ...
        {
            match: /Keyble/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Keyble'
        },
        {
            match: /oyooyo/g,
            replacement: author
        ...
        {
            match: /joachim.schaefer@gmx.net/g,
            replacement: email
        }
    ];
    var files = [
